	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'',       // Ex. post-modified-date-settings /  edit.php?post_type=page .
				__( 'Recommended', 'post-modified-date' ),
				__( 'Recommended', 'post-modified-date' ),
				'manage_options',
				'post-modified-date-recommended-plugins',
